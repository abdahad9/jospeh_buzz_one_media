  ...
  return (
    <section className="w-full py-20 px-4 sm:px-8 md:px-16 lg:px-18 bg-white">
      <div className="max-w-full mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center md:items-stretch">
        ...
        {/* Right: Card */}
        <div className="bg-[#FCF6EA] rounded-2xl p-8 md:p-12 flex flex-col gap-6 h-full">
          <div className="flex items-center gap-2 mb-2">
            <span className="w-2 h-2 bg-[#89BCE8] inline-block" />
            <span className="text-[#505050] text-base font-normal">Our Process</span>
          </div>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-medium mb-2 text-[#151515]">How We Work</h2>
          <p className="text-[#0E0E0E] text-lg font-light mb-6 max-w-2xl">
          ...
          <div className="flex flex-col gap-6">
            {steps.map((step, idx) => (
              <div key={step.title} className="flex flex-col gap-2">
                ...
                <p className="text-[#0E0E0E] text-lg font-light mt-2 text-center md:text-left">{step.desc}</p>
